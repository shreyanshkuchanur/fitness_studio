...
// index6 - offer carousel
	
	$('.single-offer-6-carousel ').owlCarousel({
                loop: true,
                margin: 30,
				loop: true,
				dots: false,
...
// index6 - clients review carousel
...
// index6 - clients review carousel
	...
	$('.client-new-carousel ').owlCarousel({
                loop: true,
                margin: 30,
				loop: true,
				dots: true,
	...
	$('.barfiller1').barfiller({ barColor: '#f55920' });
	// shop-detail
